        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected( MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    Toast.makeText(RiderActivity.this, "Profile", Toast.LENGTH_SHORT).show();
                } else if (id == R.id.nav_setting) {
                    // Uncomment when HelpFragment is ready
                    loadFragment(new SettingFragment());
                    Toast.makeText(RiderActivity.this, "Settings", Toast.LENGTH_SHORT).show();
                } else if (id == R.id.nav_logout) {
                    Toast.makeText(RiderActivity.this, "Logout", Toast.LENGTH_SHORT).show();
